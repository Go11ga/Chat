...
function ChatMsg(){
    let { chatter: chatterStore, auth: authStore } = useContext(storesContext);
    let { workMsgArr, currentMsg, changeCurrentMsg, addMsg, deleteMsg, openMsg, correctMsg, closeMsg } = chatterStore;
